...
\simpleimage[6cm]{img/solenoid_plan.png}{}
\simpleimage{img/solenoid.jpg}{Solenoid and testing frame}
...
testing flange: \WWWFile{notes/2016-nmrmag/draw.zip}

\simpleimage{img/parts.jpg}{Magnet parts}

\simpleimage{img/parts_ann.jpg}{Copper parts after annealing}

\subsection*{Magnet calculation}
Coil calculations and optimisation have been done with \MagnettiProg{} program.\\
Optimization details:\\
\WWWFile{notes/2016-nmrmag\_calc.pdf}\\
Script for optimization:\\
\WWWFile{notes/2016-nmrmag/calc\_scr.zip}\\
Calculated field profiles (text table):\\
\WWWFile{notes/2016-nmrmag/calc\_res.zip}

\simpleimage{img/field_prof.png}{Calculated field profiles}
...
\simpleimage{img/winding.jpg}{Winding process}
...
\simpleimage{img/main_coil.jpg}{Main coil}

\simpleimage{img/grad_coil.jpg}{Gradient coil}

\simpleimage{img/coil.png}{Coil layout}
...
\simpleimage{img/conn.jpg}{Connector}

\simpleimage{img/final.jpg}{Flanges}
